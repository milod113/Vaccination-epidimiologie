...
/// État vide premium de la liste des cas tétaniques.
///
/// Distingue deux situations : aucune donnée (CTA « Nouvelle évaluation »)
/// ou aucun résultat après recherche / filtres (CTA « Réinitialiser »).
class TetanusCaseEmptyState extends StatelessWidget {
  final bool hasActiveFilters;
  final VoidCallback? onReset;
  final VoidCallback? onCreate;

  const TetanusCaseEmptyState({
    super.key,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            hasActiveFilters ? 'Aucun cas trouvé' : 'Aucun cas pour le moment',

...
/// Barre de recherche premium pour la liste des patients.
///
/// Recherche sur le nom, l'identifiant, l'animal source ou le protocole
      ...
      child: AnimatedContainer(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Rechercher un patient, un identifiant ou un animal…',
            ...
            prefixIcon: Padding(
              ...
              child: Icon(
                hasQuery ? Icons.search : Icons.search,
                color: hasQuery

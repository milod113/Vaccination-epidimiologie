...
/// Squelette de chargement premium de la liste des patients.
///
/// Reproduit la structure des cartes patient (avatar, nom, badges, lignes
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          const Divider(height: 1, thickness: 1, color: EpidemiologyTheme.warm100),

...
/// Squelette de chargement premium de la liste des dossiers.
///
/// Reproduit la structure des cartes dossier (avatar, nom, badges, lignes
...
class DossierListSkeleton extends StatelessWidget {
  const DossierListSkeleton({super.key});

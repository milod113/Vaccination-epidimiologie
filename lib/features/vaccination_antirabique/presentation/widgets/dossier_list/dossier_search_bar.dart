...
/// Barre de recherche premium de la liste des dossiers.
///
/// Recherche sur le nom du patient, le numéro de dossier ou la catégorie
/// (le filtrage réel est appliqué par l'écran via [onChanged]).
class DossierSearchBar extends StatelessWidget {
  final TextEditingController controller;
  final FocusNode? focusNode;
  final ValueChanged<String> onChanged;
  final bool hasQuery;

  const DossierSearchBar({
    super.key,
      ...
      child: AnimatedContainer(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Rechercher un patient, un n° de dossier, une catégorie…',

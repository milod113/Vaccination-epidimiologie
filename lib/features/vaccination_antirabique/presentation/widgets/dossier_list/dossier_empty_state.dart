...
/// État vide premium de la liste des dossiers.
///
/// Distingue deux situations : aucune donnée (CTA « Nouveau dossier ») ou
/// aucun résultat après recherche / filtres (CTA « Réinitialiser »).
class DossierListEmptyState extends StatelessWidget {
  final bool hasActiveFilters;
  final VoidCallback? onReset;
  final VoidCallback? onCreate;

  const DossierListEmptyState({
    super.key,
        ...
        children: [
          ...
          Text(
            hasActiveFilters
                ...
                : 'Créez un premier dossier antirabique pour démarrer la '
